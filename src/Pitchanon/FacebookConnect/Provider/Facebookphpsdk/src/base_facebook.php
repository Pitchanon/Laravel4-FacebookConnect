<?php
namespace Pitchanon\FacebookConnect\Provider\Facebookphpsdk\src;
/**
...
class FacebookApiException extends \Exception // Class Exception ไม่ได้อยู่ใน namespace นี้ต้องมี \ น้ำหน้า
{
  /**
...
abstract class BaseFacebook
{
  ...
  public static $CURL_OPTS = array(
    ...
    // CURLOPT_CONNECTTIMEOUT => 30, // Pitchanon Edit
